        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="first_name" type="text" required autofocus :tabindex="1" autocomplete="first_name"
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="last_name" type="text" required :tabindex="2" autocomplete="last_name"
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="cohort" type="text" :tabindex="3" autocomplete="cohort" v-model="form.cohort"
                        placeholder="Cohort" />
                    <InputError :message="form.errors.cohort" />
                </div>

                <div class="grid gap-2">
                    <Label for="phone_number">Phone Number</Label>
                    <Input id="phone_number" type="text" required :tabindex="4" autocomplete="phone_number"
                ...
                <div class="grid gap-2 items-center justify-between">
                    <Label for="is_active" class="flex items-center space-x-3">
                        <Checkbox id="is_active" v-model="form.is_active" :tabindex="8" />
                        <span>Active ?</span>
                    </Label>
                </div>
